...
ALLOW_LIST: dict[tuple[str, str], str] = {
    ...
    ("business_settings", "custom_orders_branch_id"): _SMALL_LOOKUP,
    ("business_settings", "custom_orders_inventory_category_id"): _SMALL_LOOKUP,
    ...
    ("purchase_orders", "voided_by"): _AUDIT_ACTOR,
