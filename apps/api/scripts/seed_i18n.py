...
EN_TRANSLATIONS: list[tuple[str, str, str]] = [
    ...
    # Gift recipient — "someone else is receiving the order" (delivery only).
    ("checkout", "receiver_section", "Someone else receiving?"),
    ("checkout", "receiver_toggle", "Someone else is receiving this order"),
    (
        "checkout",
        "receiver_hint",
        "Add their name and number so the courier can reach them at drop-off.",
    ),
    ("checkout", "receiver_name_label", "Recipient's name"),
    ("checkout", "receiver_name_placeholder", "Recipient's full name"),
    ("checkout", "receiver_name_required", "Recipient's name is required"),
...
AR_TRANSLATIONS: list[tuple[str, str, str]] = [
    ...
    # مستلم الطلب — "شخص آخر يستلم الطلب" (للتوصيل فقط).
    ("checkout", "receiver_section", "شخص آخر سيستلم الطلب؟"),
    ("checkout", "receiver_toggle", "شخص آخر سيستلم هذا الطلب"),
    (
        "checkout",
        "receiver_hint",
        "أضف اسمه ورقم هاتفه ليتمكن المندوب من التواصل معه عند التسليم.",
    ),
    ("checkout", "receiver_name_label", "اسم المستلم"),
    ("checkout", "receiver_name_placeholder", "الاسم الكامل للمستلم"),
    ("checkout", "receiver_name_required", "اسم المستلم مطلوب"),
