...
class KeetaClient(BaseAggregatorClient):
    ...
    def _order_from(self, row: dict[str, Any]) -> StandardOrder | None:
        ...
        return StandardOrder(
            ...
            # "Commission" vs "Promotion expense"), and `OrderEconomics.net`
            # subtracts commission and marketing independently. Folding the
            # promotion into commission here therefore double-counted it: `net`
            # took it once as commission and again as marketing, understating the
            # kept amount by the promotion on every promoted Keeta order.
