 ...
 *
 * Ported from the storefront (`apps/web/lib/geocode.ts`) for the console's
 * custom-order address picker, so a pin dropped by staff fills the address line
 * the same way a customer's does at checkout. Keep the two in step.
 *
